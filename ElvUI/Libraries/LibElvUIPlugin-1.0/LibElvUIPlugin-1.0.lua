...
local MSG_OUTDATED = "Your version of %s %s is out of date (latest is version %s). You can download the latest version from the Ascension Launcher, or https://github.com/Ascension-Addons/ElvUI"
